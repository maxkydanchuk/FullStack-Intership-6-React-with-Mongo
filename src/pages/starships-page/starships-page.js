...
const StarshipsPage = ({onSortChange, sortOrder, setOrder, sortColumn, onSearchChange, inputValue, dispatchSetCurrentPage}) => {
    ...
    let { starshipsData = [], starshipsCurrentPage, starshipsTotalPageCount } = starshipsStore;

    useEffect(() => {
        dispatch(
            fetchStarshipsData({ sortOrder, sortColumn, inputValue, currentPage: starshipsCurrentPage }, starshipsData)
        );
